...
RED = (255,0,0)
#Back Ground music:
bg_sound = pygame.mixer.Sound(r'E:\TUATUN\PYTHON GAME\Game_ban_tau\images\background.wav')
...
LASER2 = pygame.image.load(r'E:\TUATUN\PYTHON GAME\ddddddGame_ban_tau\images\bullet2.png')
...
click_sound = mixer.Sound(r'E:\TUATUN\PYTHON GAME\Game_ban_tau\images\click.wav')
...
def main():
    ...
    while running:
        ...
        if keys[pygame.K_SPACE]:
            player.shoot()
            #Laser Sound:
            laser_sound = mixer.Sound(r'E:\TUATUN\PYTHON GAME\Game_ban_tau\images\laser.wav')
        ...
        if lives <=0 or player.health <=0:
            ...
            player.score = 0
            #Game Over Sound:
            game_over_sound = mixer.Sound(r'E:\TUATUN\PYTHON GAME\Game_ban_tau\images\game_over.wav')
        ...
        for enemy in enemies[:]:
            ...
            if collide(enemy, player):#Neu Player var cham voi enemy thi -10hp va remove enemy
                player.health -= 10
                #Explosion Sound:
                explosion_sound = mixer.Sound(r'E:\TUATUN\PYTHON GAME\Game_ban_tau\images\explosion.wav')
